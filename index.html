                        ...
                        <div class="owl-carousel owl-carousel-category">
                           ...
                           <div class="item">
                              <div class="category-item">
                                 <a href="#">
                                    ...
                                    <h6>C++<span title="" data-placement="top" data-toggle="tooltip" data-original-title="Verified"><i class="fas fa-check-circle text-success"></i></span></h6>
                                    <p>74,853 views</p>
                                 </a>
                              </div>
                           </div>
                           ...
                           <div class="item">
                              <div class="category-item">
                                 <a href="#">
                                    <img class="img-fluid" src="img/s3.png" alt="">
                                    <h6>PEN-TESTING <span title="" data-placement="top" data-toggle="tooltip" data-original-title="Verified"><i class="fas fa-check-circle text-success"></i></span></h6>
                                    <p>74,853 views</p>
                                 </a>
                              </div>
                           </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                           <div class="video-card-image">
                              <a class="play-icon" href="https://www.youtube.com/embed/1-ZkSLrk19U"><i class="fas fa-play-circle"></i></a>
                              <a href="https://www.youtube.com/embed/1-ZkSLrk19U"><img class="img-fluid" src="img/v3.png" alt=""></a>
                              <div class="time">3:50</div>
                           </div>
                           <div class="video-card-body">
                              <div class="video-title">
                                 <a href="https://www.youtube.com/embed/1-ZkSLrk19U">Basics of kali linux | kali linux basic commands part-1
</a>
                              </div>
                     ...
                     <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="video-card">
                           <div class="video-card-image">
                              <a class="play-icon" href="https://www.youtube.com/embed/1-ZkSLrk19U"><i class="fas fa-play-circle"></i></a>
   				<a href="https://youtu.be/_yICko4rjkY"><img class="img-fluid" src="img/v2.png" alt=""></a>
                 
                              <div class="time">3:50</div> /*
                           </div>
                           <div class="video-card-body">
                              <div class="video-title">
                                 <a href="#">Basics of kali linux | kali linux basic commands part-2</a>
                              </div>
                              <div class="video-page text-success">
                                 Education  <a title="" data-placement="top" data-toggle="tooltip" href="#" data-original-title="Verified"><i class="fas fa-check-circle text-success"></i></a>
                              </div>
