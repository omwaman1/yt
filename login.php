...
<?php include('functions.php') ?>
      ...
      <meta name="description" content="hacking pentesting videos">
      <meta name="author" content="hacking">
      <title>hacking videos</title>
      <!-- Favicon Icon -->
         ...
         <div class="container-fluid pl-0 pr-0">
			...
			<div class="form-group">
                        ...
                        <div class="mt-4">
                           <div class="row">
                              <div class="col-12">
                                 <button type="submit" name="login_btn" class="btn btn-outline-primary btn-block btn-lg">Sign In</button>
                              </div>
                           </div>
                        </div>
                     </form>
